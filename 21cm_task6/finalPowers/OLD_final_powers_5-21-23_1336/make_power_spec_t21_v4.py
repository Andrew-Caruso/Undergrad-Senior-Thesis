...
emissivity_file = '/expanse/lustre/scratch/andrewcaruso/temp_project/OLD_final_powers/21cm_fields_subVolumes/' #directory of the sliced 21cm field data to use. CHANGE ME
