...
emissivity_file = '/expanse/lustre/scratch/andrewcaruso/temp_project/modified_powers/21cm_fields_subVolumes/' #directory of the sliced 21cm field data to use. CHANGE ME
...
for m, model_dir in enumerate(emissivity_models):
    ...
    for n, z_str in enumerate(z_string):
        ...
        for j, cut_str in enumerate(cuts_string):
            ...
            numCells = cut_str #new number of cells for fortran code
