...
L_chosen = [L_default,100,200,300,400,500] #Mpc/h CHANGE ME
#N_chosen = [N_default,102.4,204.8,307.2,409.6,512.0] #cells CHANGE ME
N_chosen = [N_default,102,205,307,410,512] #cells CHANGE ME
...
numSteps = 8 #number of both valid and invalid steps depending on the cut size N
